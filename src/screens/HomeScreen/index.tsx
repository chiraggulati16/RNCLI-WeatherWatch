...
const HomeScreen = () => {
  ...
  const getData = async () => {
    ...
    setWeeklyData(mapHourlyWeatherData(
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flexDirection: 'row'}}>
        ...
        {weather?.current?.temperature_2m != undefined &&<Text style={styles.temperature}>{Math.round(weather?.current?.temperature_2m)}°C</Text>}
      </View>
